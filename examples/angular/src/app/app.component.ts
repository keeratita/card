...
import { DarkThemeCardFormComponent, CorporateCardFormComponent, GradientCardFormComponent, MinimalCardFormComponent } from '../components/with-custom-styling.component';
...
type ExampleView = 'home' | 'basic' | 'presets' | 'directives' | 'validators' | 'checkout' | 'omise' | 'preview' | 'dark-theme' | 'corporate' | 'gradient' | 'minimal' | 'flip-card' | 'country-dropdown';
        ...
        @if (currentView() === 'home') {
          <div class="content">
            <div class="header">
              ...
              <p>Explore different ways to integrate the card form library in your Angular applications.</p>
            </div>
            <div class="grid">
  ...
  examples = signal([
    {
      ...
      description: 'Quick start with pre-built form group and minimal configuration.'
    },
    {
      id: 'presets' as const,
      title: 'Form with Presets',
      description: 'Experiment with billing, contact, and US cardholder presets.'
    },
    {
