...
@Component({
  ...
  template: `
    <div class="container">
      ...
      <p class="subtitle">
        Interactive card preview with flip animation.
      </p>
          ...
          <div class="flip-card-face flip-card-front">
            <div style="padding: 20px; height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="color: rgba(255,255,255,0.8); font-size: 12px;">CREDIT CARD</span>
                <span style="color: white; font-weight: 600; font-size: 14px;">{{ getBrandName() }}</span>
              </div>
              <div>
                <div style="font-family: 'Courier New', monospace; font-size: 20px; letter-spacing: 2px; color: white; margin-bottom: 16px;">
                  {{ formatCardNumber() || '•••• •••• •••• ••••' }}
                </div>
                <div style="display: flex; justify-content: space-between;">
                  <div>
                    <div style="font-size: 10px; color: rgba(255,255,255,0.7); margin-bottom: 4px;">CARDHOLDER</div>
                    <div style="font-size: 12px; color: white; text-transform: uppercase;">{{ form.get('name')?.value || 'NAME' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 10px; color: rgba(255,255,255,0.7); margin-bottom: 4px;">EXPIRES</div>
                    <div style="font-size: 12px; color: white;">{{ form.get('expiry')?.value || 'MM/YY' }}</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="info-box">
        ...
        <p>
          ...
          <code>creditCardValidator()</code>, <code>expiryValidator()</code>, and 
          <code>cvcValidator()</code> for real-time form validation.
        </p>
      </div>
    </div>
  `
