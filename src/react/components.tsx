...
const BRAND_LOGOS: Record<string, React.ReactNode> = {
  ...
  amex: (
    <svg viewBox='0 0 24 24' style={{ height: '100%', fill: 'currentColor' }}>
      ...
      <path
        fill='#fff'
        d='M4 17h1.6l.8-2.3h2.3l.8 2.3H11l-2.7-7H7.7L4 17zm3.6-4.2.7-2.1.7 2.1H7.6zm5 4.2h1.5v-4.1l1.8 4.1h1.3l1.8-4.1v4.1h1.5v-7h-1.8l-2.1 4.8-2.1-4.8h-1.8v7z'
      />
    </svg>
  ),
  jcb: (
    <svg viewBox='0 0 24 24' style={{ height: '100%', fill: 'currentColor' }}>
      ...
      <path
        fill='#fff'
        d='M7 15h1.5v-4.1l1.8 4.1h1.3l1.8-4.1v4.1H15v-7h-1.8l-2.1 4.8-2.1-4.8H7v7z'
      />
    </svg>
  ),
};
...
const DEFAULT_CARD_LOGO = (
  <svg viewBox='0 0 48 48' style={{ height: '100%', fill: 'currentColor' }}>
    <path
      fill='#8e8e93'
      d='M37,40H11c-1.65,0-3-1.35-3-3V11c0-1.65,1.35-3,3-3h26c1.65,0,3,1.35,3,3v26C40,38.65,38.65,40,37,40z'
    />
